...
export class OndripNFT__idToMarketItemResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: Address;
...
export class OndripNFT extends ethereum.SmartContract {
  ...
  idToMarketItem(param0: BigInt): OndripNFT__idToMarketItemResult {
    let result = super.call(
      "idToMarketItem",
    ...
    return new OndripNFT__idToMarketItemResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toAddress(),
  ...
  try_idToMarketItem(
    param0: BigInt
  ): ethereum.CallResult<OndripNFT__idToMarketItemResult> {
    let result = super.tryCall(
      "idToMarketItem",
      "idToMarketItem(uint256):(uint256,address,uint256,address,address,uint256,bool,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new OndripNFT__idToMarketItemResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toAddress(),
